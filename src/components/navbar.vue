...
<template>
  <nav>
    <div class="navbar">
      ...
      <div class="tabs">
        <RouterLink to="/links" active-class="active">
          <svg
        ...
        <RouterLink to="/profile" active-class="active">
          ...
          <p class="tab-text">Profile Details</p>
        </RouterLink>
      </div>
      <RouterLink to="/preview" class="preview-btn">
        <span class="preview-span"> Preview </span>
        <img class="eye-icon" src="@/assets/images/icon-preview-header.svg" alt="" />
      </RouterLink>
    </div>
  </nav>
</template>
...
.navbar {
  ...
  .logo {
    background-image: url('@/assets/images/logo-devlinks-large.svg');
    background-repeat: no-repeat;
    width: 200px;
    height: 37px;

    @media (max-width: 800px) {
      background-image: url('@/assets/images/logo-devlinks-small.svg');
      width: 30px;
    }
  }
